  ...
  return (
    <div className='bg-dry py-4 border-t-2 border-black'>
      <div className='container mx-auto px-2'>
        <div className='grid grid-cols-2 md:grid-cols-7 xl:grid-cols-12 gap-5 sm:gap-9 lg:gap-11 xl:gap-7 px-3 py-10 justify-between'>
          {Links.map((link, index) => (
            <div key={index} className='col-span-1 md:col-span-2 lg:col-span-3 pb-3.5 sm:pb-0'>
              <h3 className='text-md lg:leading-7 font-medium mb-3.5 sm:mb-5 lg:mb-6 pb-0.5'>
                {link.title}
              </h3>
              <ul className='text-sm flex flex-col space-y-3'>
                {link.links.map((text, index) => (
                  <li key={index} className="flex flex-baseline">
          ...
          <div className='pb-3.5 sm:pb-0 col-span-1 md:col-span-2 lg:col-span-3 '>
            ...
            <p className='leading-7 text-sm mt-3 text-border'>
              ...
              <br />
              <span>Tel: +084 967 195 856</span>
              <br />
              <span>Email: ga6169076@gmail.com</span>
            </p>
          </div>
        </div>
      </div>
