...
function MovieInfo({ movie, setModalOpen, DownloadMovieVideo, progress }) {
    return (
        <div className='w-full xl:h-screen relative text-white'>
            ...
            />
            <div className='xl:bg-main bg-dry flex-cols xl:bg-opacity-90 xl:absolute top-0 right-0 bottom-0 left-0 '>
                <div className='container px-3 mx-auto 2xl:px-32 xl:grid grid-cols-3 flex-cols py-10 lg:py-20 gap-8'>
                    <div className='xl:col-span-1 w-full xl:order-none order-last h-header bg-dry border border-gray-800 rounded-lg overflow-hidden'>
                        <img src={movie?.titleImage ? movie?.titleImage : "/images/404.png"} alt={movie?.name} className='w-full h-full object-cover' />
                    </div>
                    <div className='col-span-2 md:grid grid-cols-5 gap-4 items-center'>
                        <div className="col-span-3 flex flex-col gap-10">
                            ...
                            <div className='flex items-center gap-4 font-medium text-dryGray'>
                                <div className='flex-cols bg-subMain text-xs px-2 py-1'>
                                    HD 4K
                                </div>
                            ...
                            <div className='grid sm:grid-cols-5 grid-cols-3 gap-4 p-6 bg-main border border-gray-800 rounded-lg'>
                                ...
                                <div className='col-span-1 flex-cols border-r border-border'>
                                    <button onClick={() => setModalOpen(true)} className='w-10 h-10 flex-cols rounded-lg bg-white bg-opacity-20'>
                                        <FaShareAlt />
                                    </button>
                                </div>
                                {/* language */}
                        ...
                        <div className='col-span-2 md:mt-0 flex justify-end'>
                            ...
                            className='md:w-1/4 w-full relative flex-cols bg-subMain hover:bg-transparent border-2 border-subMain transitions md:h-64 h-20 rounded font-medium'>
